...
//					['text' => tr_helper('bot', 'btn_profile_inline'),         'callback_data' => BotActions::PROFILE],
				],
//				[
//					['text' => tr_helper('bot', 'btn_referral_inline'),        'callback_data' => BotActions::REF],
//					['text' => tr_helper('bot', 'btn_tips_inline'),            'callback_data' => BotActions::TIPS],
//				],
				[
					['text' => tr_helper('bot', 'btn_tutorials_inline'),       'callback_data' => BotActions::TUT],
					['text' => tr_helper('bot', 'btn_referral_inline'),        'callback_data' => BotActions::REF],
//					['text' => tr_helper('bot', 'btn_config_details_inline'),  'callback_data' => BotActions::DETAILS],
				],
				[
